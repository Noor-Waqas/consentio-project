...
class AssetsExport implements FromCollection,WithHeadings
{
    ...
    public function headings():array{
        return [
            "Name","Asset Type","Hosting Type","Hosting Provider","Country","City","State","Impact","Data Classiication","Tier","Organization","It Owner","Business Owner","Business Unit","Internal 3rd Party","Data Subject Volume",];
